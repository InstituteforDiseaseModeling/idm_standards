...
At IDM, most of our reference documentation takes the form of API reference content autogenerated from Python docstrings. Generating the content directly from code helps ensure that the documentation stays up-to-date. For more guidance on docstrings, see [documentation in code](../../eng_guidance/4_documentation.md).
